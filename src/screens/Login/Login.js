      ...
      <View style={[GlobalStyles.containerCenter, { backgroundColor: color.secondary }]}>
        ...
        <View style={[styles.backgroundTop]}>
          <View style={{ padding: '2%' }}>
            <Text style={[GlobalStyles.screenTitle, GlobalStyles.textLight, { fontSize: 30 }]}>ChatApp</Text>
            <Text style={[GlobalStyles.screenTitle, GlobalStyles.textLight, { fontSize: 20 }]}>Sign In</Text>
          </View>
        </View>
