...
class ChatRoom extends Component {
    ...
    render () {
        ...
        if(conversation.length > 0 || chats.length > 0 ){
            return(

                <View style={GlobalStyles.containerFlexStart}>
                    <TopBar screenName={
                        (conversation[0].partner == null) ? conversation[0].group : conversation[0].partner 
                    } componentId={this.props.componentId}
                    refreshing={this.props._handleRefreshingConversation}
                    />
                ...
                <TouchableHighlight style={{width:'100%'}} onLongPress={() => this.setState({ overlayVisible: true,})}
                    ...
                    <View style={{
                        ...
                        <View style={{alignItems: alignItems}}>
                            <View style={[{maxWidth:'100%', minWidth:'70%',
                                padding:10,
                                marginLeft:4,
                                marginBottom:5,
                                flexDirection:'row',
                        ...
                        <TouchableOpacity onPress={() => {
                            Alert.alert(
                                ...
                                [
                                    ...
                                    {text:"delete", onPress : () => { this.props._handleDeleteChat(this.props.chat_id)
